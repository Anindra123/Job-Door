        ...
        <div class="row align-items-center mb-3">
            ...
            <div class="col-sm">
                <div class="mb-3">
                    ...
                    <input type="text" id="wtitle" name="wtitle" placeholder="" value="{{$val ?? old('wtitle')}}" class="form-control">
                </div>
        ...
        <div class="row align-items-center mb-3">
            ...
            <div class="col-sm">
                <div class="mb-3">
                    ...
                    <input type="text" id="cname" name="cname" placeholder="" value="{{$val ?? old('cname')}}" class="form-control">
                </div>
        ...
        <div class="row align-items-center mb-3">
            ...
            <div class="col-sm">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="workdesc" id="workdesc" cols="50" rows="10">{{$val ?? old('workdesc')}}</textarea>
                </div>
        ...
        <div class="row align-items-center mb-3">
            ...
            <div class="col-sm">
                <div class="mb-3">
                    ...
                    <input type="text" id="stime" name="stime" placeholder="Give date in format (dd-mm-yy)" value="{{$val ?? old('stime')}}" class="form-control">
                </div>
        ...
        <div class="row align-items-center mb-3">
            ...
            <div class="col-sm">
                <div class="mb-3">
                    ...
                    <input type="text" id="etime" name="etime" placeholder="Give date in format (dd-mm-yy)" value="{{$val ?? old('etime')}}" class="form-control">
                </div>
