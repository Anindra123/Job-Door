        ...
        <div class="row align-items-center mb-3">
            ...
            <div class="col-sm">
                <div class="mb-3">
                    ...
                    <input type="text" id="stitle" name="stitle" placeholder="" value="{{$val->service_title ?? old('stitle')}}" class="form-control">
                </div>
        ...
        <div class="row align-items-center mb-3">
            ...
            <div class="col-sm">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="servicedesc" id="servicedesc" cols="50" rows="10">{{$val->service_description ?? old('servicedesc')}}</textarea>
                </div>
