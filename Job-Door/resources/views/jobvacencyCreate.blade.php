...
<div class="container">
    ...
    <div class="row">
        <form action="/createJobVacency" method="post" class="shadow-lg p-5 m-3 bg-white" novalidate>
            {{@csrf_field()}}
            <fieldset>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" name="vcount" id="vcount" value="{{$val->vcount ?? old('vcount')}}">
